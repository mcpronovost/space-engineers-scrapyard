namespace Okp.ScrapbotSystem
{
   ...
   public static class Texts
   {
      ...
      public readonly static MyStringId GrindFaction;
      public readonly static MyStringId GrindFaction_Tooltip;
      ...
      static Texts()
      {
         ...
         GrindFaction = LocalizationHelper.GetStringId(texts, "GrindFaction");
         GrindFaction_Tooltip = LocalizationHelper.GetStringId(texts, "GrindFaction_Tooltip");
            ...
            { MyLanguagesEnum.English, new Dictionary<string, string>
               {
                  ...
                  {"GrindFaction",                    "Grind Faction"},
                  {"GrindFaction_Tooltip",            "When specified, faction specific blocks in range will be grinded."},

namespace Okp.ScrapbotSystem
{
   ...
   public static class NanobotBuildAndRepairSystemTerminal
   {
      ...
      /// <returns></returns>
      private static ScrapbotSystemBlock GetSystem(IMyTerminalBlock block)
      {
         if (block != null && block.GameLogic != null) return block.GameLogic.GetAs<ScrapbotSystemBlock>();
         return null;
      }
      ...
      public static void InitializeControls()
      {
         lock (CustomControls)
         {
            ...
            try
            {
               ...
               IMyTerminalControlTextbox textbox;
               ...
               var weldingAllowed  = (ScrapbotSystemMod.Settings.Welder.AllowedWorkModes & (WorkModes.WeldBeforeGrind | WorkModes.GrindBeforeWeld | WorkModes.GrindIfWeldGetStuck | WorkModes.WeldOnly)) != 0;
               var grindingAllowed = (ScrapbotSystemMod.Settings.Welder.AllowedWorkModes & (WorkModes.WeldBeforeGrind | WorkModes.GrindBeforeWeld | WorkModes.GrindIfWeldGetStuck | WorkModes.GrindOnly)) != 0;
               var janitorAllowed             = grindingAllowed && (ScrapbotSystemMod.Settings.Welder.AllowedGrindJanitorRelations != 0);
               var janitorAllowedNoOwnership  = janitorAllowed && ((ScrapbotSystemMod.Settings.Welder.AllowedGrindJanitorRelations & AutoGrindRelation.NoOwnership) != 0);
               var janitorAllowedOwner        = janitorAllowed && ((ScrapbotSystemMod.Settings.Welder.AllowedGrindJanitorRelations & AutoGrindRelation.Owner) != 0);
               var janitorAllowedFactionShare = janitorAllowed && ((ScrapbotSystemMod.Settings.Welder.AllowedGrindJanitorRelations & AutoGrindRelation.FactionShare) != 0);
               var janitorAllowedNeutral      = janitorAllowed && ((ScrapbotSystemMod.Settings.Welder.AllowedGrindJanitorRelations & AutoGrindRelation.Neutral) != 0);
               var janitorAllowedEnemies      = janitorAllowed && ((ScrapbotSystemMod.Settings.Welder.AllowedGrindJanitorRelations & AutoGrindRelation.Enemies) != 0);
               ...
               Func<IMyTerminalBlock, bool> isGrindFactionAllowed  = (block) => { return true; };
               ...
               Func<IMyTerminalBlock, bool> isChangeCollectPriorityPossible = (block) => {
                  var system = GetSystem(block);
                  return system != null && system.ComponentCollectPriority != null && system.ComponentCollectPriority.Selected != null && system.Settings.SearchMode == SearchModes.BoundingBox && !ScrapbotSystemMod.Settings.Welder.CollectPriorityFixed;
               };
               ...
               {
                  // --- Select search mode
                  var onlyOneAllowed = (ScrapbotSystemMod.Settings.Welder.AllowedSearchModes & (ScrapbotSystemMod.Settings.Welder.AllowedSearchModes - 1)) == 0;
                  ...
                  {
                     if (ScrapbotSystemMod.Settings.Welder.AllowedSearchModes.HasFlag(SearchModes.Grids))
                        list.Add(new MyTerminalControlComboBoxItem() { Key = (long)SearchModes.Grids, Value = Texts.SearchMode_Walk });
                     if (ScrapbotSystemMod.Settings.Welder.AllowedSearchModes.HasFlag(SearchModes.BoundingBox))
                  ...
                  comboBox.Setter = (block, value) =>
                  {
                     ...
                     if (system != null)
                     {
                        if (ScrapbotSystemMod.Settings.Welder.AllowedSearchModes.HasFlag((SearchModes)value))
                        {
                  ...
                  // --- Select work mode
                  onlyOneAllowed = (ScrapbotSystemMod.Settings.Welder.AllowedWorkModes & (ScrapbotSystemMod.Settings.Welder.AllowedWorkModes - 1)) == 0;
                  ...
                  comboBox.Setter = (block, value) =>
                  {
                     ...
                     if (system != null)
                     {
                        if (ScrapbotSystemMod.Settings.Welder.AllowedWorkModes.HasFlag((WorkModes)value))
                        {
               ...
               CustomControls.Add(label);
               {
                  // --- Enable Faction grinding
                  // separateArea = MyAPIGateway.TerminalControls.CreateControl<IMyTerminalControlSeparator, IMyShipWelder>("SeparateGrindFaction");
                  // separateArea.Visible = isGrindFactionAllowed;
                  // CustomControls.Add(separateArea);
                  /* {
                     //--Grind faction
                     textbox = MyAPIGateway.TerminalControls.CreateControl<IMyTerminalControlTextbox, IMyShipWelder>("GrindFaction");
                     textbox.Title = Texts.GrindFaction;
                     textbox.Tooltip = Texts.GrindFaction_Tooltip;
                     textbox.Enabled = isGrindFactionAllowed;
                     textbox.Visible = isGrindFactionAllowed;
                     textbox.Getter = (block) =>
                     {
                        var system = GetSystem(block);
                        return system != null ? system.Settings.UseGrindFaction : "";
                     };
                     textbox.Setter = (block, value) =>
                     {
                        var system = GetSystem(block);
                        if (system != null) {
                           system.Settings.UseGrindFaction = value;
                        }
                     };
                     CustomControls.Add(textbox);
                     CreateProperty(textbox);
                  } */
                  ...
                  //CustomControls.Add(separateArea);
                  {
                     ...
                     checkbox.Enabled = ScrapbotSystemMod.Settings.Welder.UseGrindColorFixed || !grindingAllowed ? isReadonly : isBaRSystem;
                     ...
                     {
                        var system = GetSystem(block);
                        if (system != null && !ScrapbotSystemMod.Settings.Welder.UseGrindColorFixed && isGrindingAllowed(block))
                        {
                     ...
                     CreateProperty(checkbox, ScrapbotSystemMod.Settings.Welder.UseGrindColorFixed || !grindingAllowed);

                     Func<IMyTerminalBlock, bool> colorPickerEnabled = (block) =>
                     {
                        var system = GetSystem(block);
                        return system != null && (system.Settings.Flags & SyncBlockSettings.Settings.UseGrindColor) != 0 && !ScrapbotSystemMod.Settings.Welder.UseGrindColorFixed && isGrindingAllowed(block);
                     };
                     ...
                     {
                        var system = GetSystem(block);
                        if (system != null && !ScrapbotSystemMod.Settings.Welder.UseGrindColorFixed)
                        {
                  ...
                  CustomControls.Add(separateArea);
                  {
                     ...
                     onoffSwitch.Enabled = ScrapbotSystemMod.Settings.Welder.UseGrindJanitorFixed || !janitorAllowedEnemies ? isReadonly : isBaRSystem;
                     ...
                     {
                        var system = GetSystem(block);
                        if (system != null && !ScrapbotSystemMod.Settings.Welder.UseGrindJanitorFixed && isJanitorAllowedEnemies(block))
                        {
                     ...
                     CreateProperty(onoffSwitch, ScrapbotSystemMod.Settings.Welder.UseGrindJanitorFixed || !janitorAllowedEnemies);
                     ...
                     onoffSwitch.OnText = MySpaceTexts.SwitchText_On;
                     onoffSwitch.OffText = MySpaceTexts.SwitchText_Off;
                     onoffSwitch.Enabled = ScrapbotSystemMod.Settings.Welder.UseGrindJanitorFixed || !janitorAllowedNoOwnership ? isReadonly : isBaRSystem;
                     ...
                     {
                        var system = GetSystem(block);
                        if (system != null && !ScrapbotSystemMod.Settings.Welder.UseGrindJanitorFixed && isJanitorAllowedNoOwnership(block))
                        {
                     ...
                     CustomControls.Add(onoffSwitch);
                     CreateProperty(onoffSwitch, ScrapbotSystemMod.Settings.Welder.UseGrindJanitorFixed || !janitorAllowedNoOwnership);
                     ...
                     onoffSwitch.OnText = MySpaceTexts.SwitchText_On;
                     onoffSwitch.OffText = MySpaceTexts.SwitchText_Off;
                     onoffSwitch.Enabled = ScrapbotSystemMod.Settings.Welder.UseGrindJanitorFixed || !janitorAllowedNeutral ? isReadonly : isBaRSystem;
                     ...
                     {
                        var system = GetSystem(block);
                        if (system != null && !ScrapbotSystemMod.Settings.Welder.UseGrindJanitorFixed && isJanitorAllowedNeutral(block))
                        {
                     ...
                     CustomControls.Add(onoffSwitch);
                     CreateProperty(onoffSwitch, ScrapbotSystemMod.Settings.Welder.UseGrindJanitorFixed || !janitorAllowedNeutral);
                  }
                  ...
                  CustomControls.Add(separateArea);
                  {
                     ...
                     checkbox.OnText = MySpaceTexts.SwitchText_On;
                     checkbox.OffText = MySpaceTexts.SwitchText_Off;
                     checkbox.Enabled = ScrapbotSystemMod.Settings.Welder.UseGrindJanitorFixed || !grindingAllowed ? isReadonly : isBaRSystem;
                     ...
                     {
                        var system = GetSystem(block);
                        if (system != null && !ScrapbotSystemMod.Settings.Welder.UseGrindJanitorFixed && isJanitorAllowed(block))
                        {
                     ...
                     CustomControls.Add(checkbox);
                     CreateProperty(checkbox, ScrapbotSystemMod.Settings.Welder.UseGrindJanitorFixed || !grindingAllowed);
                  ...
                  CustomControls.Add(separateArea);
                  {
                     ...
                     {
                        var system = GetSystem(block);
                        return system != null && system.BlockGrindPriority != null && system.BlockGrindPriority.Selected != null && isGrindingAllowed(block) && !ScrapbotSystemMod.Settings.Welder.PriorityFixed;
                     };
                     ...
                     {
                        var system = GetSystem(block);
                        if (system != null && system.BlockGrindPriority != null && system.BlockGrindPriority.Selected != null && isGrindingAllowed(block) && !ScrapbotSystemMod.Settings.Welder.PriorityFixed)
                        {
                     ...
                     {
                        var system = GetSystem(block);
                        if (system != null && !ScrapbotSystemMod.Settings.Welder.PriorityFixed)
                        {
               ...
               CustomControls.Add(label);
               {
                  ...
                  //CustomControls.Add(separateArea);
                  {
                     ...
                     {
                        var system = GetSystem(block);
                        if (system != null && system.ComponentCollectPriority != null && system.ComponentCollectPriority.Selected != null && !ScrapbotSystemMod.Settings.Welder.CollectPriorityFixed)
                        {
                     ...
                     {
                        var system = GetSystem(block);
                        if (system != null && !ScrapbotSystemMod.Settings.Welder.CollectPriorityFixed)
                        {
                     ...
                     checkbox.OnText = MySpaceTexts.SwitchText_On;
                     checkbox.OffText = MySpaceTexts.SwitchText_Off;
                     checkbox.Enabled = ScrapbotSystemMod.Settings.Welder.CollectIfIdleFixed ? isReadonly : isCollectPossible;
                     checkbox.Getter = (block) =>
                     {
                        var system = GetSystem(block);
                     ...
                     {
                        var system = GetSystem(block);
                        if (system != null && !ScrapbotSystemMod.Settings.Welder.CollectIfIdleFixed)
                        {
                     ...
                     CustomControls.Add(checkbox);
                     CreateProperty(checkbox, ScrapbotSystemMod.Settings.Welder.CollectIfIdleFixed);
                     ...
                     checkbox.OnText = MySpaceTexts.SwitchText_On;
                     checkbox.OffText = MySpaceTexts.SwitchText_Off;
                     checkbox.Enabled = ScrapbotSystemMod.Settings.Welder.PushIngotOreImmediatelyFixed ? isReadonly : isBaRSystem;
                     checkbox.Getter = (block) =>
                     {
                        var system = GetSystem(block);
                     ...
                     {
                        var system = GetSystem(block);
                        if (system != null && !ScrapbotSystemMod.Settings.Welder.PushIngotOreImmediatelyFixed)
                        {
                     ...
                     CustomControls.Add(checkbox);
                     CreateProperty(checkbox, ScrapbotSystemMod.Settings.Welder.PushIngotOreImmediatelyFixed);
                     ...
                     checkbox.OnText = MySpaceTexts.SwitchText_On;
                     checkbox.OffText = MySpaceTexts.SwitchText_Off;
                     checkbox.Enabled = ScrapbotSystemMod.Settings.Welder.PushItemsImmediatelyFixed ? isReadonly : isBaRSystem;
                     checkbox.Getter = (block) =>
                     {
                        var system = GetSystem(block);
                     ...
                     {
                        var system = GetSystem(block);
                        if (system != null && !ScrapbotSystemMod.Settings.Welder.PushItemsImmediatelyFixed)
                        {
                     ...
                     CustomControls.Add(checkbox);
                     CreateProperty(checkbox, ScrapbotSystemMod.Settings.Welder.PushItemsImmediatelyFixed);
                     ...
                     checkbox.OnText = MySpaceTexts.SwitchText_On;
                     checkbox.OffText = MySpaceTexts.SwitchText_Off;
                     checkbox.Enabled = ScrapbotSystemMod.Settings.Welder.PushComponentImmediatelyFixed ? isReadonly : isBaRSystem;
                     checkbox.Getter = (block) =>
                     {
                        var system = GetSystem(block);
                     ...
                     {
                        var system = GetSystem(block);
                        if (system != null && !ScrapbotSystemMod.Settings.Welder.PushComponentImmediatelyFixed)
                        {
                     ...
                     CustomControls.Add(checkbox);
                     CreateProperty(checkbox, ScrapbotSystemMod.Settings.Welder.PushComponentImmediatelyFixed);
                  }
               }
               ...
               CustomControls.Add(separateArea);
               {
                  ...
                  {
                     var system = GetSystem(block);
                     return system != null && system.Settings != null ? -system.Settings.MaximumOffset : -ScrapbotSystemBlock.WELDER_OFFSET_MAX_IN_M;
                  };
                  ...
                  Func<IMyTerminalBlock, float> getLimitMin = (block) => ScrapbotSystemBlock.WELDER_RANGE_MIN_IN_M;
                  Func<IMyTerminalBlock, float> getLimitMax = (block) =>
                  {
                     var system = GetSystem(block);
                     return system != null && system.Settings != null ? system.Settings.MaximumRange : ScrapbotSystemBlock.WELDER_RANGE_MAX_IN_M;
                  };
                  ...
                  checkbox.OnText = MySpaceTexts.SwitchText_On;
                  checkbox.OffText = MySpaceTexts.SwitchText_Off;
                  checkbox.Enabled = ScrapbotSystemMod.Settings.Welder.ShowAreaFixed ? isReadonly : isBaRSystem;
                  checkbox.Getter = (block) =>
                  {
                     var system = GetSystem(block);
                     if (system != null)
                  ...
                  {
                     var system = GetSystem(block);
                     if (system != null && !ScrapbotSystemMod.Settings.Welder.ShowAreaFixed)
                     {
                  ...
                  CustomControls.Add(checkbox);
                  CreateProperty(checkbox, ScrapbotSystemMod.Settings.Welder.ShowAreaFixed);
                  ...
                  slider.Enabled = ScrapbotSystemMod.Settings.Welder.AreaOffsetFixed ? isReadonly : isBaRSystem;
                  slider.Getter = (block) =>
                  {
                     var system = GetSystem(block);
                  ...
                  CreateProperty(slider, ScrapbotSystemMod.Settings.Welder.AreaOffsetFixed);
                  ...
                  slider.Enabled = ScrapbotSystemMod.Settings.Welder.AreaSizeFixed ? isReadonly : isBaRSystem;
                  slider.Getter = (block) =>
                  {
                     var system = GetSystem(block);
                  ...
                  CreateProperty(slider, ScrapbotSystemMod.Settings.Welder.AreaSizeFixed);
                  ...
                  slider.Enabled = ScrapbotSystemMod.Settings.Welder.SoundVolumeFixed ? isReadonly : isBaRSystem;
                  slider.Getter = (block) =>
                  {
                     var system = GetSystem(block);
                     return system != null ? 100f * system.Settings.SoundVolume / ScrapbotSystemBlock.WELDER_SOUND_VOLUME : 0f;
                  };
                  slider.Setter = (block, val) =>
                  {
                     var system = GetSystem(block);
                     if (system != null)
                     {
                        ...
                        var max = 100;
                        val = val < min ? min : val > max ? max : val;
                        system.Settings.SoundVolume = (float)Math.Round(val * ScrapbotSystemBlock.WELDER_SOUND_VOLUME) / 100f;
                     }
                  };
                  slider.Writer = (block, val) =>
                  {
                     ...
                     if (system != null)
                     {
                        val.Append(Math.Round(100f * system.Settings.SoundVolume / ScrapbotSystemBlock.WELDER_SOUND_VOLUME) + " %");
                     }
                  };
                  slider.SupportsMultipleBlocks = true;
                  CustomControls.Add(slider);
                  CreateSliderActions("SoundVolume", slider);
                  CreateProperty(slider, ScrapbotSystemMod.Settings.Welder.SoundVolumeFixed);
               }

               // -- Script Control
               if (!ScrapbotSystemMod.Settings.Welder.ScriptControllFixed)
               {
